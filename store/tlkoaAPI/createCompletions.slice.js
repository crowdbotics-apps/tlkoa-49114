...
export const modules_openai_completion_create = createAsyncThunk("createCompletions/modules_openai_completion_create", async payload => {
...
const createCompletionsSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(modules_openai_completion_create.pending, (state, action) => {
