...
export const modules_openai_edits_create = createAsyncThunk("createEdits/modules_openai_edits_create", async payload => {
...
const createEditsSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(modules_openai_edits_create.pending, (state, action) => {
